...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{{\Large David S. Li}} & Email : \href{mailto:dsli@outlook.com}{ds.li@outlook.com}\\
  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
          ...
          \item{University Scholar, Presidential Scholarship Recepient}
          \resumeItemListEnd
...
\section{Projects}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{Course Site Generator}
      {JavaFX application for assisting instructors in creating easy-to-use course websites.  JavaScript and CSS front end with JSON objects utilized to store data.}
