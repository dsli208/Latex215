...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \item{}
          {Currently working to improve efficiency of a counting quotient filter by implementing a resize function using multithreading in C.}
      \resumeItemListEnd
    \resumeSubheading
      {HSY Hi-Tech Co. Ltd.}{Beijing, China}
      {Intern}{June - August 2018}
      \resumeItemListStart
        \item{}
         {Worked with employees to familiarize myself with CAD software to present to prospective customers.}
        \resumeItemListEnd
    \resumeSubheading
      {Stony Brook University}{Stony Brook, NY}
